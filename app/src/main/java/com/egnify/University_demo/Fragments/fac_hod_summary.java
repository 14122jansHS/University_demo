 ...
 */
public class fac_hod_summary extends Fragment {
     ...
     * number.
     */
    public static fac_hod_summary newInstance(int number, ArrayList<HashMap<String, String>> filelist, int sectionNumber) {
        fac_hod_summary fragment = new fac_hod_summary();
