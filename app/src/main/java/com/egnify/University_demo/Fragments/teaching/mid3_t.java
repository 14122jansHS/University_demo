 ...
 */
public class mid3_t extends Fragment {
    ...
    public static mid3_t newInstance(int i, ArrayList<attend_info> atten_arr, ArrayList<ArrayList<ArrayList<stu_info>>> stu_arr, ArrayList<ArrayList<ArrayList<stu_info>>> mstu_arr, ArrayList<attend_info> mrks_arr, ArrayList<attri_details> attri_detail_arr) {
        mid3_t fragment = new mid3_t();
    ...
    private void set_table() {
        ...
        mid1_a_stu = l_stu_arr.get(2);
        mid1_m_stu=m_stu_arr.get(2);
    ...
    private void setchart(BarChart chart) {
        ...
        attend_info atten_pojo = atten_arr.get(2);
        attend_info marks_pojo = mrks_arr.get(2);
        attri_details alot_pojo = attri_detail_arr.get(2);
