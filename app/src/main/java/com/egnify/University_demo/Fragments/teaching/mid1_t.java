...
import com.egnify.University_demo.Adapter.m_d_adapter;
 ...
 */
public class mid1_t extends Fragment {
    ...
    public static mid1_t newInstance(int i, ArrayList<attend_info> atten_arr, ArrayList<ArrayList<ArrayList<stu_info>>> stu_arr, ArrayList<ArrayList<ArrayList<stu_info>>> mstu_arr, ArrayList<attend_info> mrks_arr, ArrayList<attri_details> attri_detail_arr) {
        mid1_t fragment = new mid1_t();
    ...
    private void set_table() {
        ...
        mid1_a_stu = l_stu_arr.get(0);
        mid1_m_stu=m_stu_arr.get(0);
    ...
    private void setchart(BarChart chart) {
        ...
        attend_info atten_pojo = atten_arr.get(0);
        attend_info marks_pojo = mrks_arr.get(0);
        attri_details alot_pojo = attri_detail_arr.get(0);
        ...
        for (int j = 0; j <= 2; j++)
        {
            ...
            if (j == 0) {
                ...
                per_tv.setText(df.format(fper));
                point_tv.setText(alot_pojo.getMarks());
            } else if (j == 1) {
                metric_name.setText("Attendance");
                Double l_m = Double.parseDouble(atten_pojo.getClass_avg());
                per_tv.setText(df.format(l_m));
                point_tv.setText(atten_pojo.getMarks());
            }
            if (j == 2) {
                metric_name.setText("Marks");
                Double l_m = Double.parseDouble(marks_pojo.getClass_avg());
                per_tv.setText(df.format(l_m));
