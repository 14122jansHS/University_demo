 ...
 */
public class class_mid extends Fragment {
    ...
    private String[] row_headings = {"Exams", "Mid Marks avg(%)", "Points/Marks"};
    ...
    public static class_mid newInstance(int sectionNumber, attribute_obj l_obj) {
        class_mid fragment = new class_mid();
        Bundle args = new Bundle();
        args.putSerializable("class_attendance", l_obj);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //return inflater.inflate(R.layout.fragment_class_mid, container, false);

        rootView = inflater.inflate(R.layout.fragment_class_mid, container, false);
        ...
        allo_obj = (attribute_obj) getArguments().getSerializable("class_attendance");
        if (atten_arr.size() <= 0) {
            try {
                JSONArray jArr = new JSONArray(allo_obj.getMetrics());
                JSONObject jobj = jArr.getJSONObject(2);
    ...
    private void setchart(LineChart chart) {
        ...
        for (int i = 0; i < atten_arr.size(); i++) {
            ...
            Float ma_mrk = Float.parseFloat(latt_arr.getClass_avg());
    ...
    public void set_table() {
        ...
        metric_name.setText("Mid Exam Performance");
        String tol = total_scr.getText().toString();
        total_scr.setText("Total Points: " + total_points);
