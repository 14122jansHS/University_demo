...
import com.egnify.University_demo.pojos.stu_marks;
 ...
 */
public class cons_attendance  extends Fragment {
    ...
    private String[] row_headings = {"Exams", "Attendance avg(%)", "Points/Marks"};
     ...
     * number.
     */
    public static cons_attendance newInstance(int sectionNumber, attribute_obj l_obj) {
        cons_attendance fragment = new cons_attendance();
        Bundle args = new Bundle();
        args.putInt(ARG_SECTION_NUMBER, sectionNumber);
        args.putSerializable("cons_attendance", l_obj);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
         ...
         rootView = inflater.inflate(R.layout.fragment_con_atten, container, false);
        ...
        allo_obj = (attribute_obj) getArguments().getSerializable("cons_attendance");
        atten_arr.clear();
        try {
            String over_all_score=allo_obj.getFinal_points() ;
            JSONArray jArr = new JSONArray(allo_obj.getMetrics());
            JSONObject jobj = jArr.getJSONObject(0);
            metric_name = "Counselling Students";
            final_attendance_avg = jobj.getString("final_attendance_avg");
    ...
    private void set_det_table()
    {
        ...
        final ArrayList<String> stu_name_a = new ArrayList<>();
        ...
        for (int f=0;f<mid1.size();f++)
        {
            final stu_marks stu_pojo = std_info.get(f);
            View stu_row=lf.inflate(R.layout.stu_row, null);
            LinearLayout main_click = (LinearLayout) stu_row.findViewById(R.id.main_click);
            ...
            main_click.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(getActivity(), new_student.class);
                    Bundle bundle = new Bundle();
                    //bundle.putSerializable("fac_details", f_list);
                    intent.putExtra("stu_name", stu_name_a.get(finalF));
                    intent.putExtra("stu_id", String.valueOf(finalF + 1));
    ...
    public void set_table() {
        ...
        metric_name.setText("Class Attendance");
        ...
        for (int r = 0; r < atten_arr.size(); r++) {
            ...
            for (int l = 0; l < row_headings.length; l++) {
                ...
                if (l == 0) {
                    ...
                    Double l_m = Double.parseDouble(att_pojo.getClass_avg());
                    DecimalFormat df = new DecimalFormat("##.0");
                    tv_v.setText(df.format(l_m));
                } else {
