 ...
 */
public class class_attendance extends Fragment {
    ...
    public static class_attendance newInstance(int sectionNumber, attribute_obj l_obj) {
        class_attendance fragment = new class_attendance();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_class_attendance, container, false);
