 ...
 */
public class vc_dept_detail extends Fragment {
     ...
     * number.
     */
    public static vc_dept_detail newInstance(int number, ArrayList<HashMap<String, String>> filelist) {
        vc_dept_detail fragment = new vc_dept_detail();
