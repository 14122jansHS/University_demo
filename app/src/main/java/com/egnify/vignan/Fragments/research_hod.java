 ...
 */
public class research_hod extends Fragment {
    ...
    public static research_hod newInstance(int sectionNumber, attribute_obj l_obj) {
        research_hod fragment = new research_hod();
        Bundle args = new Bundle();
        args.putInt(ARG_SECTION_NUMBER, sectionNumber);
        args.putSerializable("reserach_hod", l_obj);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        allo_obj = (attribute_obj) getArguments().getSerializable("reserach_hod");
    ...
    private void set_ui() {
        for(int s=0;s<heading_arr.size();s++)
        {
            ...
            View sub_point_l=lf.inflate(R.layout.expand_card, null);
