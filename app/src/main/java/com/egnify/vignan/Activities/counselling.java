...
import com.egnify.vignan.Fragments.cons_academics;
import com.egnify.vignan.Fragments.cons_attendance;
...
public class counselling extends AppCompatActivity {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            if (position == 0) {
                attribute_obj l_obj=filelist.get(1);
                fragment = cons_attendance.newInstance(position + 1,l_obj);
            } else {
                attribute_obj l_obj=filelist.get(1);
                fragment = cons_academics.newInstance(position + 1,l_obj);
            }
